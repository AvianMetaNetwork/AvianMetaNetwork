...
df <- read.csv(here::here("../Avian-Interaction-Database-Working/L1/amn_cac.csv"))
...
Source `_figure_processing.R` which contains the data processing and plotting functions. See `7_figure_processing_vignette.qmd` for further explanation of the data processing and plot functions!
