...
#' function to read in any year of bbs file, but default to 2024
bbs_splist<- function(bbs_file_name= BBS_LIST_FILE) {
  bbs.splist24<-read.csv(bbs_file_name, fileEncoding="UTF-8")
}
...
checklist<-read.csv(CHECKLIST_FILE)
